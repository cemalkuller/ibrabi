...
<div class="row">
	<div class="col-lg-5 col-md-12">
		<div class="box box-primary">
			...
			<!-- form start -->
			<?php echo form_open_multipart('brand_admin_controller/add_brand_post'); ?>
										...
										<td>
											<div class="dropdown">
												...
												<ul class="dropdown-menu options-dropdown">
													<li>
														<a href="<?php echo admin_url(); ?>update-brand/<?php echo html_escape($item->id); ?>"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a>
													</li>
													<li>
														<a href="javascript:void(0)" onclick="delete_item('brand_admin_controller/delete_brand_post','<?php echo $item->id; ?>','Silmek istediğinize emin misiniz?');"><i class="fa fa-trash option-icon"></i><?php echo trans('delete'); ?></a>
													</li>
												</ul>
											</div>
										</td>
