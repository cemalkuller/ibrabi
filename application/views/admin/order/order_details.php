    ...
    <div class="col-sm-12">
        <div class="box">
            <div class="box-header with border">
                ...
                <?php if($order->has_cargo == 0): ?>
                <div class="text-right"><a class="btn btn-sm btn-success pull-right btn-site-prev" href="/admin/kargo-olustur/<?php echo $order->id; ?>">Kargo Oluştur</a></div>
                <?php endif; ?>
            </div>
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <?php if($order->barkod !== NULL): ?>
                            <a class="btn btn-sm btn-success pull-left btn-site-prev" target="_blank" href="/admin/barkod/<?php echo $order->barkod; ?>">Barkod Yazdır</a>
                        <?php endif; ?>
                    </div>
                </div>
        </div>
