...
<div class="wrapper">
    ...
    <aside class="main-sidebar" style="background-color: #515765;">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo admin_url(); ?>upload-excel"> Excel Şablonu Yükle</a></li>
                        <li><a href="<?php echo admin_url(); ?>excel-templates"> Excel Şablonları</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo admin_url(); ?>main-banners"> Ana Banner</a></li>
                        <li><a href="<?php echo admin_url(); ?>sidebar-banners"> Sidebar Banner</a></li>
                    </ul>
                </li>

                <li>
                    <a href="<?php echo admin_url(); ?>brands">
                        <i class="fa fa-fa"></i> <span>Markalar</span>
                    </a>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo admin_url(); ?>add-campaign"> Kampanya Ekle</a></li>
                        <li><a href="<?php echo admin_url(); ?>campaigns"> Kampanyalar</a></li>
                    </ul>
                </li>
