	...
	<div class="col-lg-5 col-md-12">
		<div class="box box-primary">
			...
			<div class="box-header with-border">
				<h3 class="box-title">Ana Banner Ekle</h3>
			</div><!-- /.box-header -->
			...
			<div class="box-footer">
				<button type="submit" class="btn btn-primary pull-right">Ana Banner Ekle</button>
			</div>
			<!-- /.box-footer -->
										...
										<td>
											<div class="dropdown">
												...
												<ul class="dropdown-menu options-dropdown">
													<li>
														<a href="<?php echo admin_url(); ?>update-banner/<?php echo html_escape($item->id); ?>/1"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a>
													</li>
													<li>
