...
<div class="row">
	<div class="col-lg-5 col-md-12">
		<div class="box box-primary">
			...
			<div class="box-header with-border">
				<h3 class="box-title">Sidebar Banner Ekle</h3>
			</div><!-- /.box-header -->
			...
			<div class="box-footer">
				<button type="submit" class="btn btn-primary pull-right">Sidebar Banner Ekle</button>
			</div>
			<!-- /.box-footer -->
	...
	<div class="col-lg-7 col-md-12">
		<div class="box">
			<div class="box-header with-border">
				<h3 class="box-title">Sidebar Banner</h3>
			</div><!-- /.box-header -->
										...
										<td>
											<div class="dropdown">
												...
												<ul class="dropdown-menu options-dropdown">
													<li>
														<a href="<?php echo admin_url(); ?>update-banner/<?php echo html_escape($item->id); ?>/2"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a>
													</li>
													<li>
