            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12 col-option">
                            <input type="radio" name="location" value="links" id="menu_information" class="square-purple" <?php echo ($page->location == "links") ? 'checked' : ''; ?>>
                            <label for="menu_information" class="option-label">Bağlantılar</label>
                        </div>
                    </div>
                </div>
