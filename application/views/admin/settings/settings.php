    ...
    <div class="col-md-12">
        ...
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li class=""><a href="#tab_5" data-toggle="tab" aria-expanded="false"><?php echo trans('custom_css_codes'); ?></a></li>
                <li class=""><a href="#tab_6" data-toggle="tab" aria-expanded="false"><?php echo trans('custom_javascript_codes'); ?></a></li>
            ...
            <div class="tab-content settings-tab-content">
                ...
                <div class="tab-pane" id="tab_3">
                    ...
                    <div class="form-group">
                        <label class="control-label">Whatsapp <?php echo trans('url'); ?></label>
                        <input type="text" class="form-control" name="whatsapp_url"
                               placeholder="Whatsapp <?php echo trans('url'); ?>" value="<?php echo html_escape($settings->whatsapp_url); ?>" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?>>
                    </div>
