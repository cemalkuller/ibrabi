...
<div class="row">
	<div class="col-lg-5 col-md-12">
		...
		<div class="box">
			<div class="box-header with-border">
				<h3 class="box-title">Kelime Ekle</h3>
			</div>
			<!-- /.box-header -->

			<!-- form start -->
			<?php echo form_open_multipart('language_controller/add_word_post'); ?>
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="<?php echo $language->short_form; ?>" placeholder="<?php echo $language->name; ?>"
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="label" placeholder="<?php echo trans('label'); ?>"
						   value="<?php echo old('label'); ?>" maxlength="200" required>
				</div>
			...
			<!-- /.box-body -->
			<div class="box-footer">
				<button type="submit" class="btn btn-primary pull-right">Kelime Ekle</button>
			</div>
			<!-- /.box-footer -->
			<?php echo form_close(); ?><!-- form end -->
		</div>
