...
<div class="row">
    <div class="col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="info-box-content">
            <span class="info-box-text"><?php echo trans("orders"); ?></span>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="info-box-content">
            <span class="info-box-text"><?php echo trans("products"); ?></span>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
        <span class="info-box-icon bg-green"><i class="fa fa-low-vision"></i></span>

        <div class="info-box-content">
            <span class="info-box-text"><?php echo trans("pending_products"); ?></span>
            <span class="info-box-number"><?php echo $pending_product_count; ?></span>
        </div>
        <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="info-box-content">
            <span class="info-box-text"><?php echo trans("members"); ?></span>
