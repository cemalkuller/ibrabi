...
<div id="wrapper" class="index-wrapper">
    <div class="container">
        ...
        <div class="row ml-1 mb-4">
            <?php foreach($brands as $banner): ?>
            <div class="col-md-1 col-3">
                <a href="<?php echo $banner->link; ?>">
                    <img src="<?php echo site_url($banner->image); ?>" class="rounded-circle img-fluid brand-logo-img">
        ...
        <div class="row">
            ...
            <?php if(!empty($main_banners)): ?>
            <div class="col-sm-12 col-md-9 banners">
                <?php foreach($main_banners as $banner): ?>
                <div class="col-12 section">
                    <a href="<?php echo $banner->link; ?>">
                        <img src="<?php echo site_url($banner->image); ?>" class="img-fluid">
            ...
            <div class="col-sm-12 col-md-3 pl-0 pr-0">
                ...
                <div class="col-12 section sidebar-box">
                    <a href="<?php echo $banner->link; ?>">
                        <img src="<?php echo site_url($banner->image); ?>" class="img-fluid">
                    </a>
                </div>
