    ...
    <div class="row-custom<?php echo (!empty($product->image_second)) ? ' product-multiple-image' : ''; ?>">
        ...
        <div class="img-product-container">
            ...
            if (!empty($product_condition)):?>
                <span style="position:absolute; z-index:999; background: #535353; top: 20px;left: 20px;width: 58px;font-size: 11px;color: #fff;padding: 5px 5px;text-transform: uppercase;border-radius: 3px;"><?php echo html_escape($product_condition->option_label); ?></span>
            <?php endif; ?>
