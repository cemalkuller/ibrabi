        ...
        <div class="row">
            ...
            <?php if (!empty($user_products)): ?>
                <div class="col-12 section section-related-products m-t-30">
                    <h3 class="title">SATICININ DİĞER ÜRÜNLERİ<?php //echo trans("more_from"); ?>&nbsp;<!--<a href="<?php //echo generate_profile_url($product->user_slug); ?>"><?php echo html_escape($product->user_username); ?></a>--></h3>
