...
<?php else: ?>
    <meta property="og:image" content="<?php echo site_url('assets/img/pazaryeri2-og-image.jpg');//echo get_logo($this->general_settings); ?>"/>
...
<?php endif; ?>
    <style>body {font:family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,"Noto Sans",sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol","Noto Color Emoji" !important;<?php //echo $this->fonts->font_family; ?>}</style>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-8 nav-top-left">
                                <div class="row-align-items-center">
                                    <div class="logo">
                                        ...
                                        <!-- <h1 class="logo-text"><a href="<?php echo lang_base_url(); ?>">iBrabi</a></h1> -->
                                    </div>
                                    ...
                                    <div class="top-search-bar">
                                        ...
                                        <?php if ($this->general_settings->multi_vendor_system == 1): ?>
                                            ...
                                            <div class="right">
                                                ...
                                                <button class="btn btn-default btn-search text-light"><i class="icon-search"></i></button>
                                                <div id="response_search_results" class="search-results-ajax"></div>
                                                <?php if(!empty($latest_searchs)): ?>
                                                    <div class="last_searchs" style="display:none">
                                                        <h7>
                                                            <strong>Geçmiş Aramalar</strong>
                                                            <a href="#" style="float: right;">Temizle</a>
                                                        </h7>
                                                        <ul>
                                                            <?php foreach($latest_searchs as $search): ?>
                                                                <li><a href="#"><?php echo $search->keyword; ?></a></li>
                                                            <?php endforeach; ?>
                                                        </ul>
                                                    </div>
                                                <?php endif; ?>
                            ...
                            <div class="col-md-4 nav-top-right">
                                ...
                                <?php if ($this->auth_check): ?>
                                    <li class="nav-item dropdown profile-dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a style="color:#e74513 !important;font-weight: 500;">
                                                <?php
                                                if(!empty(get_shop_name($this->auth_user))):
                                                    echo get_shop_name($this->auth_user);
                                                else:
                                                    echo $this->auth_user->username;
                                                endif;
                                                ?>
                                                </a>
                                            </li>
                                            ...
                                            <?php if ($this->auth_user->role == "admin" or $this->auth_user->role == "vendor"): ?>
                                                <li>
                                                    <a href="<?php echo generate_url('dashboard'); ?>">
                                                        <i class="icon-user"></i>
                                ...
                                <?php else: ?>
                                    <li class="nav-item">
                                        <a href="#" class="nav-link a-profile" href="javascript:void(0)" data-toggle="modal" data-target="#loginModal">
                                            <i class="icon-user" style="font-size: 20px"></i>
                                            Hesabım
                                        </a>
                                    </li>
