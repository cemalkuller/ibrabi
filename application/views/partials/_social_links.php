...
<ul>
    ...
    <?php endif; ?>
    <?php if (!empty($this->settings->whatsapp_url)): ?>
        <li><a href="<?php echo html_escape($this->settings->whatsapp_url); ?>" class="youtube"><i class="icon-whatsapp"></i></a></li>
    <?php endif; ?>
    <?php if (!empty($this->settings->telegram_url)): ?>
        <li><a href="<?php echo html_escape($this->settings->telegram_url); ?>" class="youtube"><i class="fa fa-telegram"></i></a></li>
    <?php endif; ?>
