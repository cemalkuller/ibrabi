												...
												<ul class="payment-options-list">
													...
													<li>
														<div class="option-payment">
															<div class="list-left">
																<div class="custom-control custom-radio">
																	<input type="radio" class="custom-control-input" id="option_paymo" name="payment_option" value="paymo" required <?php echo ($check_option == true) ? 'checked' : ''; ?>>
																	<label class="custom-control-label label-payment-option" for="option_paymo">Paymo</label>
																</div>
															</div>
															<div class="list-right">
																<label for="option_paymo">
																	<img src="<?php echo base_url(); ?>assets/img/payment/humo.png" alt="humo" style="height: 30px;">
																	<img src="<?php echo base_url(); ?>assets/img/payment/uzkart.png" alt="uzkart" style="height: 30px;">
																</label>
															</div>
														</div>
													</li>
