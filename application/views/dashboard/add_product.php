...
<h1 class="jumbotron-heading pt-3 pb-3 pl-3 pr-3" style="font-size: 28px;">TEKİL ÜRÜN OLUŞTUR</h1>
<div class="ml-3 mr-3">
<!-- Wrapper -->
<div id="wrapper">
    <div class="">
                        ...
                        <div class="col-12 col-md-12 col-lg-9">
                            ...
                            <div class="row mb-5">
                                <div class="col-12">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary float-right"><?php echo trans("save_and_continue"); ?></button>
                                    </div>
