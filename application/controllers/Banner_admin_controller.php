...
class Banner_admin_controller extends Admin_Core_Controller
{
    ...
    {
        $data['title'] = 'Ana Banner';
        $data['banners'] = $this->banner_model->get_banner_items(1);

        $this->load->view('admin/includes/_header', $data);
        $this->load->view('admin/banners/main_banners');
    ...
    */
    ...
    {
        $data['title'] = 'Sidebar Banner';
        $data['banners'] = $this->banner_model->get_banner_items(2);

        $this->load->view('admin/includes/_header', $data);
        $this->load->view('admin/banners/sidebar_banners', $data);
        $this->load->view('admin/includes/_footer');
    }
    ...
    {
        $data['title'] = 'Markalar';
        $data['banners'] = $this->banner_model->get_banner_items(3);

        $this->load->view('admin/includes/_header', $data);
        $this->load->view('admin/banners/brands', $data);
        $this->load->view('admin/includes/_footer');
    }

    /**
     * Add Main Banner Post
     */
    public function add_banner_post()
    {
        if ($this->banner_model->add_banner()) { 
     ...
     * Update Main Banner
     */
    public function update_banner($id, $type)
    {
        $data['title'] = 'Banner Düzenle';
        //get banner
        $data['item'] = $this->banner_model->get_banner_item($id);
        $data['type'] = $type;

        $this->load->view('admin/includes/_header', $data);
        $this->load->view('admin/banners/update_banner', $data);
        $this->load->view('admin/includes/_footer');
    }
    ...
    public function update_banner_post()
    {
        ...
        if ($this->banner_model->update_banner($id)) {
     ...
     */
    public function delete_main_banner_post()
    {
        $id = $this->input->post('id', true);
        if ($this->banner_model->delete_banner($id)) {
            $this->session->set_flashdata('success', 'Banner başarıyla silindi.');
        } else {
            $this->session->set_flashdata('error', trans("msg_error"));
        }
    }
