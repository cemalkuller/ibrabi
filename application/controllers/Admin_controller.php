...
class Admin_controller extends Admin_Core_Controller
{
    ...
    */
    ...
    public function campaigns()
    {
        ...
        $this->load->view('admin/includes/_header', $data);
        $this->load->view('admin/campaign/campaigns', $data);
        $this->load->view('admin/includes/_footer');
    }
    ...
    public function add_campaign_post()
    {
        ...
        if ($this->campaign_model->add_campaign()) {
            ...
            $this->session->set_flashdata('form_data', trans("msg_error"));
            $this->session->set_flashdata('error', trans("msg_error"));
            redirect($this->agent->referrer());
        }
    }
    ...
    {
        $data['title'] = 'Kampanya Düzenle';
        //get item
        $data['item'] = $this->campaign_model->get_campaign($id);
        $this->load->view('admin/includes/_header', $data);
        $this->load->view('admin/campaign/update_campaign', $data);
        $this->load->view('admin/includes/_footer');
    }
    ...
    public function update_campaign_post()
    {
        //item id
        $id = $this->input->post('id', true);
        if ($this->campaign_model->update_campaign($id)) {
            $this->session->set_flashdata('success', trans("msg_updated"));
     ...
     */
    public function delete_campaign_post()
    {
        $id = $this->input->post('id', true);
        if ($this->campaign_model->delete_campaign($id)) {
            $this->session->set_flashdata('success', trans("msg_deleted"));
        } else {
            $this->session->set_flashdata('error', trans("msg_error"));
        }
